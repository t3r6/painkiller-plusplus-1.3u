...
function MagicBoard:Setup()
  ...
  if Game.AddOn then
    for i, o in MagicCards.timeCards, nil do
      if o.index < 25 then
        Game.CardsAvailable[o.index] = true
      end
    end
    for i, o in MagicCards.permCards, nil do
  ...
  while i do
    ...
    if not Game.AddOn and o.numSlots > 4 then
      numSlots = 12
    end
    local x = o.x_pk
    local y = o.y_pk
...
function MagicBoard_UpdateCardsStatus()
  for i, o in MagicCards.timeCards, nil do
    if Game.CardsAvailable[o.index] and (o.index < 25 or Game.AddOn) then
