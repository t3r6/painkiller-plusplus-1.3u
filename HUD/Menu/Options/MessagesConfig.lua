MessagesConfig =
{
	...
	items =
	{
		...
		GeneralSettings =
		{
			...
			action = "PainMenu:ApplySettings(); PainMenu:ActivateScreen(ControlsConfig); PMENU.SetBorderSize( 'KeyBorder', 924, 385 ); PMENU.SetScrollerHeight('KeyScroller',415); PainMenu:HideTabGroup(PainMenu.currScreen.items.AdvancedTab, 'AdvancedTab'); PainMenu:ShowTabGroup(PainMenu.currScreen.items.GeneralTab, 'GeneralTab')",
