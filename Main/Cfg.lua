...
Cfg = {
  ...
  HUD_Scores = true,
  HUD_Scores_Frame = 1,
  HUD_Scores_A_Setting = {
    50,
    733,
    1
  },
  HUD_Scores_A_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Scores_B_Setting = {
    50,
    683,
    1
  },
  HUD_Scores_B_Setting_Save = {
    0,
    0,
    0
  },
  ...
  HUD_Flag_Icon_Setting = {
    0,
    -280,
    0.73
  },
  HUD_Flag_Icon_Setting_Save = {
    0,
    0,
    0
  },
  ...
  HUD_Rage_Icon_Setting = {
    489,
    0,
    0.73
  },
  HUD_Rage_Icon_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Modifier_Icon_Setting = {
    489,
    70,
    0.73
  },
  HUD_Modifier_Icon_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Immunity_Icon_Setting = {
    489,
    -70,
    0.73
  },
  HUD_Immunity_Icon_Setting_Save = {
    0,
    0,
    0
  },
  ...
  HUD_Medals_Icon_Setting = {
    0,
    240,
    0.73
  },
  HUD_Medals_Icon_Setting_Save = {
    0,
    0,
    0
  },
  ...
  HUD_Icons_Trans = 255,
  HUD_Armor_Icon_Setting = {
    987,
    30,
    0.58
  },
  HUD_Armor_Text_Setting = {
    937,
    30,
    0.55
  },
  HUD_Health_Icon_Setting = {
    987,
    66,
    0.58
  },
  HUD_Health_Text_Setting = {
    937,
    66,
    0.55
  },
  HUD_Weapon1_Icon_Setting = {
    37,
    66,
    0.58
  },
  HUD_Weapon2_Icon_Setting = {
    37,
    30,
    0.58
  },
  HUD_CurrentWeapon_Icon_Setting = {
    512,
    48,
    0.8
  },
  HUD_Weapon1_Text_Setting = {
    87,
    66,
    0.55
  },
  HUD_Weapon2_Text_Setting = {
    87,
    30,
    0.55
  },
  HUD_CurrentWeapon_Icon_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Weapon1_Icon_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Weapon1_Text_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Weapon2_Icon_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Weapon2_Text_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Armor_Icon_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Armor_Text_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Health_Icon_Setting_Save = {
    0,
    0,
    0
  },
  HUD_Health_Text_Setting_Save = {
    0,
    0,
    0
  },
  ...
  HUD_Bar_Trans = 125,
  HUD_Ammolist_Marker_RGB = {
    125,
    125,
    125
  },
  HUD_Ammolist_Marker_Trans = 125,
  HUD_Ammolist_Count_RGB = {
    255,
    255,
    255
  },
  ...
  HUD_FragMessage_Status_Setting = {
    400,
    4,
    22
  },
  HUD_FragMessage_Status_Setting_Save = {
    0,
    0,
    0
  },
  ...
  KeyPrimaryPause = "None",
  KeyPrimaryPreviousWeapon = "Mouse Wheel Back",
  KeyPrimaryQuickLoad = "None",
  KeyPrimaryQuickSave = "None",
  ...
  BotTaunts = {
    "are you trying?",
    "lag",
    "do you know who vo0 is?",
    "erm?",
    "...?",
    "I'm not even trying, can you tell?",
    "hmm?",
    "are you aliasing?",
    "damn netcode",
    "u sux",
    "i dont know this map that well",
    "pie",
    "I'm only using keys",
    "Try harder? :)",
    ":o)",
    "hahahahehehe :-)",
    "All hail the king!",
    "leave the armour for me please",
    "I own Maniax, do you know him?",
    ":DDDD",
    "blah",
    "hmmm",
    "stop using the rl please",
    "can we play fallen2 after this?",
    "my mouse feels odd",
    "my monitor just went off",
    "hmm",
    "erm",
    "hm",
    "nm",
    "give me a sec while I clean my mouse",
    "hi",
    "k?",
    "wtf?",
    "cpl what?",
...
function Cfg:Load()
  ...
  label = label and string.lower(label)
  ...
  if type(Cfg.TextureQuality) == "string" then
    Cfg.TextureQuality = 0
  end
  if type(Cfg.TimeLimit) == "string" then
    Cfg.TimeLimit = 10
  end
  if type(Cfg.FragLimit) == "string" then
    Cfg.FragLimit = 15
  end
  ...
  if 1 > Cfg.PlayerModel or 7 < Cfg.PlayerModel then
    Cfg.PlayerModel = 1
  end
  ...
  if IsMPDemo() then
    Cfg.Credits = false
    if Cfg.PlayerModel > 4 then
      Cfg.PlayerModel = 1
    end
  end
  if Cfg.MaxPlayers < 1 or Cfg.MaxPlayers > 16 then
    Cfg.MaxPlayers = 8
  end
  if 0 > Cfg.MaxSpectators or 8 < Cfg.MaxSpectators then
    Cfg.MaxSpectators = 0
  end
  ...
  if type(Cfg.BestExplosives[1]) == "string" or 15 > table.getn(Cfg.WeaponPriority) then
    Cfg.BestExplosives = {
      0,
      41,
      32
    }
    Cfg.BestNonExplosives = {
      72,
      71,
      62,
      61,
  ...
  if type(Cfg.ConnectionSpeed) == "string" then
    Cfg.ConnectionSpeed = 5
  end
  if 1 > Cfg.ConnectionSpeed or Cfg.ConnectionSpeed > 5 then
    Cfg.ConnectionSpeed = 5
  end
  if 0 > Cfg.WheelSensitivity then
    Cfg.WheelSensitivity = 0
  end
  if 4 < Cfg.WheelSensitivity then
    Cfg.WheelSensitivity = 4
  end
  if 1 > Cfg.MouseSensitivity then
    Cfg.MouseSensitivity = Cfg.MouseSensitivity * 400
  end
  ...
  elseif 0 > Cfg.GraphicsQuality then
    Cfg.GraphicsQuality = 0
  end
  Cfg.PlayerName = HUD.ColorSubstr(tostring(Cfg.PlayerName), 16)
  if Cfg.CrosshairSize > 3 then
    Cfg.CrosshairSize = 3
  end
  if Cfg.CrosshairSize < 0.2 then
    Cfg.CrosshairSize = 0.2
  end
  ...
  if 0 > Cfg.StartupWeapon or 7 < Cfg.StartupWeapon then
    Cfg.StartupWeapon = 0
  end
end
...
function Cfg_ClearKeyBinding(key)
  ...
  while name do
    if (string.find(name, "KeyAlternative") or string.find(name, "KeyPrimary")) and Cfg[name] == key then
      Cfg[name] = "None"
    end
