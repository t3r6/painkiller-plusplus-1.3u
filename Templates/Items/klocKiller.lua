...
function klocKiller:OnCreateEntity()
...
function klocKiller:EditTick( delta )
...
function klocKiller:Start()
	self._stopped = false
end

function klocKiller:Stop()
    ENTITY.PO_MaintainVelocity( self._Entity, false )
...
function klocKiller:Tick(delta)
...
function klocKiller:OnCollision(x,y,z,nx,ny,nz,e_other,h_me,h_other,vx,vy,vz,vl,velocity_me, velocity_other)	--e.he
