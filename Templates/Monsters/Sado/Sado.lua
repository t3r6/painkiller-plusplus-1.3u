...
function Sado:WeaponFireL(par3, par4, par5)
...
function Sado:WeaponFireR(par3, par4, par5)
	if self._AIBrain._weaponR then
		self._AIBrain:WeaponFire(par3, par4, par5)
	end
end

function Sado:CustomOnHit()
	local brain = self._AIBrain
