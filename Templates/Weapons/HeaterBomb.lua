...
function HeaterBomb:OnPrecache()
	...
	Cache:PrecacheParticleFX("explo_ammoboxNoSmoke")  --OriOn_Modification
	Cache:PrecacheParticleFX("explo_ammoboxNoExplos") --OriOn_Modification
...
function HeaterBomb:Client_Explosion(entity,x,y,z)
	...
	elseif Cfg.NoSmoke and not Cfg.NoExplosions then
		local pfx = AddPFX("explo_ammoboxNoSmoke",0.1,Vector:New(x,y,z))
	elseif not Cfg.NoSmoke and Cfg.NoExplosions then
		local pfx = AddPFX("explo_ammoboxNoExplos",0.1,Vector:New(x,y,z))		--=end=OriOn_Modification
	end
end
-------------------------------------------------------------------------------
